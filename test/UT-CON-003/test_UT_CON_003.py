"""
UT-CON-003: Pruebas para validar incrementos en contratos establecidos
ID: UT-CON-003
HU: HU-CON-003 - Agregar, Modificar y Eliminar Incrementos
Endpoint: POST /established_contracts/create_established_contract/ (con incrementos)
...
class TestEstablishedContractIncreases:
    """Pruebas de validación de incrementos al crear contratos"""
    ...
    def _get_base_payload(self):
        """Base para contratos con incrementos"""
        return {
            "id_employee_charge": 1,
            "contract_type": 19,
    ...
    def test_ut_con_003_1_contrato_con_incremento_fijo_exitosa(self, mock_audit):
        """Crear contrato con incremento fijo exitosa retorna 201"""
        ...
        payload['description'] = 'Contrato con incremento fijo'
        payload['established_increases'] = [{
            ...
            "end_date_increase": str(self.tomorrow),
            "description": "incremento test",
            "amount": 1
        }]
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_2_contrato_con_incremento_porcentaje(self, mock_audit):
        """Crear contrato con incremento porcentaje válido retorna 201"""
        mock_audit.return_value.create = MagicMock()
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Contrato con incremento porcentaje'
        payload['established_increases'] = [{
            "increase_type": 32,
            ...
            "start_date_increase": str(self.today),
            "end_date_increase": str(self.tomorrow),
            "description": "incremento porcentaje",
            "amount": 1
        }]
    ...
    def test_ut_con_003_3_sin_autenticacion_retorna_401(self):
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_4_sin_permiso_retorna_403(self, mock_audit):
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_5_incremento_tipo_invalido(self, mock_audit):
        """Tipo de incremento inválido retorna 400"""
        mock_audit.return_value.create = MagicMock()
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento tipo inválido'
        payload['established_increases'] = [{
            "increase_type": 999,
            "amount_type": "fijo",
            "amount_value": 50000,
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_6_amount_value_negativo(self, mock_audit):
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento monto negativo'
        payload['established_increases'] = [{
            "increase_type": 31,
            "amount_type": "fijo",
            "amount_value": -50000,
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_7_porcentaje_mayor_100(self, mock_audit):
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento porcentaje > 100'
        payload['established_increases'] = [{
            "increase_type": 31,
            "amount_type": "Porcentaje",
            "amount_value": 150,
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_8_fecha_fin_anterior_inicio(self, mock_audit):
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento fechas inválidas'
        payload['established_increases'] = [{
            "increase_type": 31,
            "amount_type": "fijo",
            "amount_value": 50000,
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_9_campo_obligatorio_faltante(self, mock_audit):
        """Campo obligatorio faltante en incremento retorna 400"""
        mock_audit.return_value.create = MagicMock()
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento campo faltante'
        payload['established_increases'] = [{
            "amount_type": "fijo",
            "amount_value": 50000,
            "application_increase_type": "SalarioBase"
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_10_multiples_incrementos_exitosa(self, mock_audit):
        """Crear contrato con múltiples incrementos exitosa retorna 201"""
        mock_audit.return_value.create = MagicMock()
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Contrato con múltiples incrementos'
        payload['established_increases'] = [
            {
                "increase_type": 31,
                "amount_type": "fijo",
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_11_incremento_misma_aplicacion_mismo_tipo(self, mock_audit):
        """Dos incrementos mismo tipo sin justificación retorna 400"""
        mock_audit.return_value.create = MagicMock()
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento duplicado'
        payload['established_increases'] = [
            {
                "increase_type": 31,
                "amount_type": "fijo",
            ...
            },
            {
                ...
                "amount_value": 25000,
                "application_increase_type": "SalarioBase",
                "start_date_increase": str(self.tomorrow),
                "end_date_increase": str(self.week_later)
            }
        ]
    ...
    @patch('payroll.api.established_contract_viewset.AuditClient')
    def test_ut_con_003_12_descripcion_excede_max_caracteres(self, mock_audit):
        """Descripción incremento excede max caracteres (255) retorna 400"""
        mock_audit.return_value.create = MagicMock()
        ...
        payload = self._get_base_payload()
        payload['description'] = 'Incremento descripción larga'
        payload['established_increases'] = [{
            "increase_type": 31,
            "amount_type": "fijo",
            "amount_value": 50000,
