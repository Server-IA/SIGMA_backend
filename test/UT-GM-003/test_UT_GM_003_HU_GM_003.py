...
def _create_mock_user_with_permissions(permission_id=90):
...
def _create_mock_auth_payload(permission_id=90):
...
class TestMaintenanceUpdate:
    ...
    def setup_method(self):
        ...
        self.responsible_user.is_authenticated = True
    ...
    # ========== CASO 1: UT-GM-003 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_successful_update_happy_path(self, mock_check_permission):
        """
        ...
        mock_user = type('MockUser', (), {
            ...
            'email': 'test@test.com',
            'name': 'Test User',
            'roles': [{'permisos': [{'id': 90}]}],  # maintenance.update
            'permissions': [{'id': 90}]
        })()
    ...
    # ========== CASO 2: UT-GM-003.1 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_empty_name_validation(self, mock_check_permission):
        """
    ...
    # ========== CASO 3: UT-GM-003.2 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_missing_maintenance_type_validation(self, mock_check_permission):
        """
    ...
    # ========== CASO 4: UT-GM-003.4 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_name_max_length_100_exact(self, mock_check_permission):
        """
    ...
    # ========== CASO 5: UT-GM-003.5 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_name_length_exceeded_101(self, mock_check_permission):
        """
    ...
    # ========== CASO 6: UT-GM-003.6 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_description_max_length_300_exact(self, mock_check_permission):
        """
    ...
    # ========== CASO 7: UT-GM-003.7 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_description_length_exceeded_301(self, mock_check_permission):
        """
    ...
    # ========== CASO 8: UT-GM-003.8 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_name_uniqueness_case_insensitive_with_spaces(self, mock_check_permission):
        """
    ...
    # ========== CASO 9: UT-GM-003.9 ==========
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_description_omitted_optional_field(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_invalid_maintenance_type_not_active(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_user_without_permissions(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_maintenance_not_found(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_invalid_id_format(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_fields_with_trailing_spaces_trim(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_immutable_fields_ignored(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_nonexistent_responsible_user(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_incorrect_content_type_header(self, mock_check_permission):
        """
    ...
    @patch('maintenance.api.maintenance_viewset.MaintenanceViewSet.check_permission')
    def test_put_idempotency(self, mock_check_permission):
        """
