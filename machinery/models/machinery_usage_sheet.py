...
class MachineryUsageSheet(models.Model):
    ...
    usage_condition = models.ForeignKey('parameterization.Types', on_delete=models.PROTECT, null=False, blank=False, related_name='usage_condition_machinery_usage_sheets')
