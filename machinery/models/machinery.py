...
class Machinery(models.Model):
    ...
    machinery_type = models.ForeignKey('parameterization.Types', on_delete=models.PROTECT, null=False, blank=False)
    ...
    machinery_secondary_type = models.ForeignKey('parameterization.Types', on_delete=models.PROTECT, null = False, blank = False)
    id_city = models.IntegerField(null=True, blank=True)
    image_path = models.CharField(max_length=255, null=True, blank=True)
    id_device = models.ForeignKey('parameterization.TelemetryDevices', on_delete=models.PROTECT, null=True, blank=True)
