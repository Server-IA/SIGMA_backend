...
class MaintenanceRequest(models.Model):
    ...
    detected_at = models.DateTimeField(db_column="detected_at", null=False, blank=False)
    is_automatic = models.BooleanField(default=False, db_column="is_automatic", help_text="Indica si la solicitud fue generada automáticamente")
