...
class PayrollIncrease(models.Model):
    AMOUNT_TYPE_CHOICES = [
    ...
    id_payroll_increase = models.AutoField(primary_key=True, db_column="id_payroll_increase")
    increase_type = models.ForeignKey("parameterization.Types", on_delete=models.PROTECT, related_name="payroll_increases_by_type", db_column="increase_type", null=False, blank=False)
