...
class ContractPaymentsEstablishedContract(models.Model):
    ...
    id_day_of_week = models.ForeignKey("payroll.DaysOfWeek", on_delete=models.PROTECT, related_name="contract_payments_by_day", db_column="id_day_of_week", null=True, blank=True)
