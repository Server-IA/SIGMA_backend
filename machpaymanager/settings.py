...
ROOT_URLCONF = 'machpaymanager.urls'
...
WSGI_APPLICATION = 'machpaymanager.wsgi.application'
...
CRONJOBS = [
    ...
    # Cada minuto: generar solicitudes automáticas de mantenimiento por horas de uso
    ('*/1 * * * *', 'maintenance.cron.generate_automatic_maintenance_requests_job', '>> /proc/1/fd/1 2>&1'),
